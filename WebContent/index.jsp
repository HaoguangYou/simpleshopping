	...
	<!-- start header -->
		<header>
			<div class="top center">
				<div class="left fl">
					<ul>
						<li><a href="http://www.baidu.com/" target="_blank">小米商城</a></li>
						<li>|</li>
						<li><a href="">MIUI</a></li>
						<li>|</li>
						<li><a href="">米聊</a></li>
...
<!-- start banner_x -->
		<div class="banner_x center">
			...
			<div class="nav fl">
				...
				<% 
				//获取页面传过来的值
				Object  obList = request.getAttribute("bList");
				List<broad> bList = (List<broad>)obList;
				if(bList!=null){
					for(int i=0;i<bList.size();i++){
						%>
						<!-- 传一个大类的id给servlet，用来获取商品信息 -->
						<li><a href="goodsServlet?BroadId=<%=bList.get(i).getBroadId() %>" ><%=bList.get(i).getProductName() %></a></li>
